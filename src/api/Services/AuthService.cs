...
using System.Net;
//using DroidInvest.Auth;
//using Microsoft.AspNetCore.Http.Internal;
//using Microsoft.AspNetCore.Http;
using DroidInvest.Models.Auth;
...
namespace DroidInvest.Services
{
    public class AuthService
    {
        ...
        internal static AuthModel GetLoginInfo(IDictionary<string,string> headers)
        {
        ...
        /*internal static AuthModel GetLoginInfo(IDictionary<string,string> q)
        {
            var loginInfo = new AuthModel();

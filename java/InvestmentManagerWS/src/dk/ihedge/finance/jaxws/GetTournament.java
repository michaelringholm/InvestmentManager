...
@XmlRootElement(name = "getTournament", namespace = "http://finance.ihedge.dk/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getTournament", namespace = "http://finance.ihedge.dk/", propOrder = {"login", "tournamentID"})

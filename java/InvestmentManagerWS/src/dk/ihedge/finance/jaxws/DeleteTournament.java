...
@XmlRootElement(name = "deleteTournament", namespace = "http://finance.ihedge.dk/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "deleteTournament", namespace = "http://finance.ihedge.dk/", propOrder = {"login", "tournamentID"})
